...
- [ ] `[cli|mcp|desktop]` SKIP: demo site — no CLI, no destructive actions
- [ ] `[cli|mcp|desktop]` SKIP: demo site — reads static HTML, writes to results/
...
- [ ] `[cli]` SKIP: not a CLI tool
- [ ] `[cli|mcp|desktop]` SKIP: demo site — no logging levels
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[complex]` SKIP: demo site — not complex enough for handbook

## D. Shipping Hygiene

- [x] `[all]` `verify` script exists (CI pipeline runs a11y scans) (2026-02-27)
...
- [ ] `[npm]` SKIP: private demo site — not published to npm
- [ ] `[npm]` SKIP: private demo site — not published to npm
- [ ] `[npm]` SKIP: private demo site — not published to npm
